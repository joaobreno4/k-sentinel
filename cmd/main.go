...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8ffd1d3f.kubeobserver.io",
	...
	ddClient, err := observability.NewDatadogClient()
	if err != nil {
		setupLog.Error(err, "Failed to initialize Datadog client")
		os.Exit(1)
	}
